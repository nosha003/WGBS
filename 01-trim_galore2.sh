#!/bin/bash -l
#PBS -l walltime=96:00:00,nodes=1:ppn=8,mem=50gb
#PBS -N trim_galore
#PBS -r n
#PBS -m abe
...
#gunzip /scratch.global/nosha003/wgbs_schmitz/PH207/reads/${ID}.fastq.gz
#gunzip /scratch.global/nosha003/wgbs_schmitz/PH207/reads/${ID2}.fastq.gz
...
-o $trimmedfolder --paired /scratch.global/nosha003/wgbs_schmitz/PH207/reads/${ID}.fastq /scratch.global/nosha003/wgbs_schmitz/PH207/reads/${ID2}.fastq
...
#gzip /scratch.global/nosha003/wgbs_schmitz/PH207/${ID}.fastq
#gzip /scratch.global/nosha003/wgbs_schmitz/PH207/${ID2}.fastq
