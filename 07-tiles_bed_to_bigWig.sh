...
########## Run #################
        ...
        perl /home/springer/nosha003/pete/scripts/springerlab_methylation/SeqCap/met_context_window.pl /scratch.global/nosha003/doebley/analysis/BSMAPratio/${ID}_BSMAP_out.txt 100

        #move output into tiles folder
        mv -v /scratch.global/nosha003/doebley/analysis/BSMAPratio/${ID}_BSMAP_out.txt.100.*.bed /scratch.global/nosha003/doebley/analysis/tiles/
