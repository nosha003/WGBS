...
########## Run #################
        ...
        -o BSMAPratio/${ID}_methratio2.txt \
        -d ${genome_reference} \
        -u \
        -z \
        -r bsmapped/${ID}_sorted.bam
        ...
        #Make bigWigs
        /home/springer/nosha003/software/kentUtils/bin/bedGraphToBigWig "BSMAPratio/${ID}_BSMAP_out_CG.bedGraph" /home/springer/nosha003/database/PH207/PH207_chr_size.txt \
        "BSMAPratio/${ID}_BSMAP_out_CG.bigWig"
        /home/springer/nosha003/software/kentUtils/bin/bedGraphToBigWig "BSMAPratio/${ID}_BSMAP_out_CHG.bedGraph" /home/springer/nosha003/database/PH207/PH207_chr_size.txt \
        "BSMAPratio/${ID}_BSMAP_out_CHG.bigWig"
        /home/springer/nosha003/software/kentUtils/bin/bedGraphToBigWig "BSMAPratio/${ID}_BSMAP_out_CHH.bedGraph" /home/springer/nosha003/database/PH207/PH207_chr_size.txt \
	...
	# check if there is PT CHH data
        ...
        BSMAPratio/${ID}_BSMAP_out2.txt |wc -l)
        echo $PT_data
