...
########## Run #################
        ...
        perl /home/springer/nosha003/pete/scripts/springerlab_methylation/SeqCap/met_context_window.pl /scratch.global/nosha003/wgbs/w22/analysis/BSMAPratio/${ID}_BSMAP_out.txt 100

        #move output into tiles folder
        mv -v /scratch.global/nosha003/wgbs/w22/analysis/BSMAPratio/${ID}_BSMAP_out.txt.100.*.bed /scratch.global/nosha003/wgbs/w22/analysis/tiles/
        ...
        --args ${ID} tiles /home/maize/shared/databases/genomes/Zea_mays/W22/W22__Ver12.genome.normalized_100bp_tiles_zBased_sites_counts.txt
