...
script_dir=/home/springer/nosha003/pete/scripts/springerlab_methylation/SeqCap
script_to_qsub=${script_dir}/${step}2.sh
...
#to run
#bash /home/springer/nosha003/scripts/pete/springerlab_methylation/SeqCap/01-trim_galore_qsub.sh <sample_list.txt>
