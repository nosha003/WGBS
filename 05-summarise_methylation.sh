...
########## Run #################
        ...
        -u \
        -z \
        -r bsmapped_filtered/${ID}_sorted_MarkDup.bam
...
UT}"/${SAMPLE_LIST}"
        ...
        #Make bigWigs
        /home/springer/nosha003/software/kentUtils/bin/bedGraphToBigWig "BSMAPratio/${ID}_BSMAP_out_CG.bedGraph" /home/springer/nosha003/database/B73v4/B73v4_chr_size.txt \
        "BSMAPratio/${ID}_BSMAP_out_CG.bigWig"
        /home/springer/nosha003/software/kentUtils/bin/bedGraphToBigWig "BSMAPratio/${ID}_BSMAP_out_CHG.bedGraph" /home/springer/nosha003/database/B73v4/B73v4_chr_size.txt \
        "BSMAPratio/${ID}_BSMAP_out_CHG.bigWig"
        /home/springer/nosha003/software/kentUtils/bin/bedGraphToBigWig "BSMAPratio/${ID}_BSMAP_out_CHH.bedGraph" /home/springer/nosha003/database/B73v4/B73v4_chr_size.txt \
