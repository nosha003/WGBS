...
for example:
bash \
/home/springer/nosha003/scripts/pete/springerlab_methylation/SeqCap/05-summarise_methylation_qsub.sh \
single_sample.txt \
/home/springer/nosha003/database/Zea_mays.AGPv4.dna.toplevel.fa \
...
script_to_qsub=${scriptdir}/${step}2_greg.sh
